export const ptBRStrings = {
  global: {
    ...
    select: "Selecionar",
    cpfLabel: "CNPJ",
    cpfPlaceholder: "XX.XXX.XXX/XXXX-XX",
  ...
  securityScreen: {
    ...
    cpfModalTitle: "Para confirmar, digite seu CNPJ",
    yes: "Sim",
    no: "Não",
    send: "Enviar",
  ...
  admin: {
    ...
    reports: {
      title: "Relatórios",
      description: "Gere relatórios completos de uso, performance financeira e atividades suspeitas.",
