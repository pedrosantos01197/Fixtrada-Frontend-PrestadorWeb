export const enUSStrings = {
  ...
  cadastroVeiculo: {
    ...
    userIdError: "Could not find your user ID. Please try logging in again.",
    validationMessage: "Please fill in Make, Model, Year (YYYY), Mileage, and Color with valid data.",
  ...
  recuperarSenha: {
    ...
    passwordChangedSuccess: "Your password has been changed. Please log in with your new password.",
    newPasswordLabel: "New Password",
  ...
  home: {
    ...
    cardSubtitle: "Schedule a service quickly and find the best professionals near you.",
  ...
  inputComponent: {
    ...
    fuelOptions: {
      ...
      additiveGasoline: "Additive Gasoline",
